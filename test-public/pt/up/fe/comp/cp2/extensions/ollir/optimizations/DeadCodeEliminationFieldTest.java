...
public class DeadCodeEliminationFieldTest extends OllirTestEnv {
    ...
    public DeadCodeEliminationFieldTest() {
    ...
    @Test
    public void testDeadCodeEliminationSimpleField() {
        baseTest();
        var method = optimize("DeadCodeEliminationSimpleField", "foo", false);
    }

    @Test
    public void testDeadCodeEliminationSimpleFieldAndLocal() {
        var method = optimize("DeadCodeEliminationSimpleFieldAndLocal", "foo", true);
        assertIdRefCount("x", method, 0);
    }
